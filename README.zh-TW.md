...
<p align="center">
  [<a href="https://github.com/IT-Bill/BiCone/releases/latest">下載安裝</a>] [<a href="https://github.com/IT-Bill/BiCone/blob/main/README.md">简体中文</a>] [<a href="https://github.com/IT-Bill/BiCone/blob/main/README.en.md">English</a>] [<a href="https://github.com/IT-Bill/BiCone/blob/main/README.ja.md">日本語</a>]
</p>
...
> [!NOTE]
> BiCone 支援 **Android**、**iOS**（TestFlight / 自簽 IPA）和 **Windows** 平台。
...
- **TestFlight**（推薦）— 已提交 TestFlight 公測，請透過 [TestFlight 連結](https://testflight.apple.com/join/PLACEHOLDER) 加入
- **自簽 IPA** — 從 [Releases](https://github.com/IT-Bill/BiCone/releases/latest) 下載 `unsigned.ipa`，使用 AltStore、Sideloadly 等工具自行簽名安裝
